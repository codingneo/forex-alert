...
def is_hammer(open_price, high_price, low_price, close_price):
    ...
    real_body_threshold = (high_price - low_price) * 0.1
    ...
    is_bullish_hammer = (lower_shadow >= 2 * real_body) and (real_body <= real_body_threshold) and (upper_shadow < lower_shadow * 0.2)
...
def is_shooting_star(open_price, high_price, low_price, close_price):
    ...
    is_shooting_star = (upper_shadow >= 2 * real_body) and (real_body <= real_body_threshold) and (lower_shadow < upper_shadow * 0.2)
